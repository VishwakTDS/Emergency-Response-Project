...
# cause_prediction_llm_model = 'nvidia/llama-3.3-nemotron-super-49b-v1.5'
# insights_agents_model = 'nvidia/llama-3.3-nemotron-super-49b-v1.5'
...
cause_prediction_llm_model_hf = 'nvidia/Llama-3_1-Nemotron-Ultra-253B-v1:nebius'
insights_agents_model_hf = 'nvidia/Llama-3_1-Nemotron-Ultra-253B-v1:nebius'
